...
public class OrdinationperiodR7 extends PatientGeneralData {
    ...
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd")
    private Date weigthDate;
    private Short opLmh;
    private int lmhDose;
    private float preferedIntStart;
    private float preferedIntEnd;

    public OrdinationperiodR7(String cId,
                              int oid,
                              int pid,
                              String firstName,
                              String lastName,
                              ...
                              short opLmh,
                              int lmhDose,
                              float preferedIntStart,
                              float preferedIntEnd

    ) throws OrdinationperiodException, PatientGeneralDataException {
        ...
        this.weight = weight;
        this.weigthDate = weigthDate;
        this.opLmh = opLmh;
        this.lmhDose = lmhDose;
        this.preferedIntStart = preferedIntStart;
        this.preferedIntEnd = preferedIntEnd;
        try {
...
//            Objects.requireNonNullElse(complfolYear, "complfolYear is null");
    ...
    public float getPreferedIntStart() {
        return preferedIntStart;
    }

    public void setPreferedIntStart(float preferedIntStart) {
        this.preferedIntStart = preferedIntStart;
    }

    public float getPreferedIntEnd() {
        return preferedIntEnd;
    }

    public void setPreferedIntEnd(float preferedIntEnd) {
        this.preferedIntEnd = preferedIntEnd;
    }
    ...
    public Date getWeigthDate() {
        return weigthDate;
    }

    public void setWeigthDate(Date weigthDate) {
        this.weigthDate = weigthDate;
    }

    public Short getOpLmh() {
        return opLmh;
    }

    public void setOpLmh(Short opLmh) {
        this.opLmh = opLmh;
    }

    public int getLmhDose() {
        return lmhDose;
    }

    public void setLmhDose(int lmhDose) {
        this.lmhDose = lmhDose;
    }
    ...
    public String toString() {
        return "OrdinationperiodR7{" +
                ...
                ", weight=" + weight +
                ", weigthDate=" + weigthDate +
                ", opLmh=" + opLmh +
                ", lmhDose=" + lmhDose +
                ", preferedIntStart=" + preferedIntStart +
                ", preferedIntEnd=" + preferedIntEnd +
                '}';
    }
}
