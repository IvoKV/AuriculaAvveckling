...
public class PDFMatvardeL {
    private List<MatvardeL> matvardeLList = null;

    private final String pdfPathFileName = "out\\PDFMatvardeL.pdf";
    ...
    public PDFMatvardeL(List<MatvardeL> matvardeL) throws IOException {
        this.matvardeLList = matvardeL;
    ...
    private void writeHeader() throws IOException {
        ...
        contentStream.showText("Mätvärden");
    ...
    private void writePatientInfo() throws IOException {
        ...
        contentStream.showText(matvardeLList.get(0).getFirstName());
        contentStream.endText();
        yHold = y;
        y -= leading;
        ...
        contentStream.newLineAtOffset(xTab1, 0);
        contentStream.showText(matvardeLList.get(0).getLastName());
        contentStream.endText();
        y -= leading;
        ...
        contentStream.newLineAtOffset(xTab1, 0);
        contentStream.showText(matvardeLList.get(0).getSsn());
        contentStream.endText();
        yHold -= leading;
        ...
        contentStream.newLineAtOffset(xTab1, 0);
        contentStream.showText(matvardeLList.get(0).getSsnType().toString());
        contentStream.endText();
        yHold -= fontSize / 2;
    ...
    public void createMatvardeLDetails() throws IOException, GeneralBefattningReadJSONException {
        ...
        if (contentStream != null) {
            ...
            int arraySize = matvardeLList.size();
            ...
            for(int arrayItem = 0; arrayItem < arraySize; arrayItem++ ) {
                ...
                contentStream.newLineAtOffset(xTab1, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrH1());
                contentStream.endText();
                y -= leading;
                ...
                contentStream.newLineAtOffset(xTab1, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrE1());
                contentStream.endText();
                y -= leading;
                ...
                contentStream.newLineAtOffset(xTab1, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrM());
                contentStream.endText();
                y -= leading;
                ...
                contentStream.newLineAtOffset(xTab1, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrR1());
                contentStream.endText();
                y -= leading;
                ...
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrH2());
                contentStream.endText();
                yHold -= leading;
                ...
                contentStream.newLineAtOffset(xTab2, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrA());
                contentStream.endText();
                yHold -= leading;
                ...
                contentStream.newLineAtOffset(xTab2, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrG());
                contentStream.endText();
                yHold -= leading;
                ...
                contentStream.newLineAtOffset(xTab2, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrE2());
                contentStream.endText();
                yHold -= leading;
                ...
                contentStream.newLineAtOffset(xTab2, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getHmrS());
                contentStream.endText();

                /* CREATED BY */
                StringBuilder sbcr = new StringBuilder();
                GeneralBefattningReadJSON gbj = new GeneralBefattningReadJSON(matvardeLList.get(arrayItem).getHmrCreatedBy());
                ...
                GeneralBefattningReadJSON gbj2 = new GeneralBefattningReadJSON(matvardeLList.get(arrayItem).getHmrUpdatedBy());
                ...
                contentStream.newLineAtOffset(100, 0);
                contentStream.showText(matvardeLList.get(arrayItem).getHmrTsCreated().toString().substring(0, 19));
                contentStream.endText();
                y -= leading * 2;
                ...
                contentStream.newLineAtOffset(xTab1, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getChaC());
                contentStream.endText();
                y -= leading;
                ...
                contentStream.newLineAtOffset(xTab1, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getChaH());
                contentStream.endText();
                y -= leading;
                ...
                contentStream.newLineAtOffset(xTab2, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getChaD());
                contentStream.endText();
                yHold -= leading;
                ...
                contentStream.showText("Stroke (S):");
                contentStream.newLineAtOffset(xTab2, 0);
                TextShower.showString(contentStream, matvardeLList.get(arrayItem).getChaS());
                contentStream.endText();
                yHold -= leading;

                /* CREATED BY */
                StringBuilder sbCHAcr = new StringBuilder();
                GeneralBefattningReadJSON gbjCHAcr = new GeneralBefattningReadJSON(matvardeLList.get(arrayItem).getChaCreatedBy());
                ...
                GeneralBefattningReadJSON gbjCHAupd = new GeneralBefattningReadJSON(matvardeLList.get(arrayItem).getChaUpdatedBy());
                ...
                contentStream.showText("Created:");
                contentStream.newLineAtOffset(100, 0);
                contentStream.showText(matvardeLList.get(arrayItem).getChaTsCreated().toString().substring(0, 19));
                contentStream.endText();
                y -= leading * 2;
            }
        ...
        fop = null;
        String filenameWithSSN = fileWithoutExtension + "_" + matvardeLList.get(0).getSsn() + ".pdf";
